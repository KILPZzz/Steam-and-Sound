...
public class AdvancedHUDPacket extends SimplePacketBase {
	...
	public AdvancedHUDPacket() {}

	public AdvancedHUDPacket(Train train) {
		trainId = train.id;
	...
	public AdvancedHUDPacket(FriendlyByteBuf buffer) {
	...
	public static class Serverbound extends AdvancedHUDPacket {
